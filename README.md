...
- Бұл README **толық inline SVG** пайдаланады — ешқандай қосымша файл қажет емес.  
- Егер GitHub-тың Markdown рендеріне байланысты SVG-тер көрінбесе, кейбір символдарды (мысалы `font-family`) өзгертіп көр. Бірақ әдетте GitHub inline SVG-ді көрсетеді.  
- Егер атыңды немесе кейбір кодтарды өзгерткің келсе — осы README ішіндегі SVG блоктарын тікелей өңдеп қой.
